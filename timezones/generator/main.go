...
func main() {
	...
	// Generate Go code
	if err := generateGoCode(cities); err != nil {
...
func generateGoCode(cities map[string]string) error {
	...
	// Write header
	fmt.Fprintln(f, "// Code generated by generator/main.go. DO NOT EDIT.")
	fmt.Fprintln(f, "// Source: GeoNames[](https://www.geonames.org/)")
	fmt.Fprintln(f, "// License: Creative Commons Attribution 4.0")
	fmt.Fprintln(f)
	fmt.Fprintln(f, "package timezones")
	fmt.Fprintln(f)
	fmt.Fprintln(f, "// GeneratedCities maps city names to IANA timezone identifiers")
